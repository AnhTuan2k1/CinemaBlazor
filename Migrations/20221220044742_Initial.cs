    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeActors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikeActors_Actors_ActorId",
                        column: x => x.ActorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectionRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectionRooms_Cinemas_CinemaId",
                        column: x => x.CinemaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeDirectors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikeDirectors_Directors_DirectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Customer = table.Column<int>(type: "int", nullable: false),
                    FilmId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comments_Movies_FilmId1",
                        column: x => x.FilmId1,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorNavigationId = table.Column<int>(type: "int", nullable: true),
                    FilmId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FilmActors_Actors_ActorNavigationId",
                        column: x => x.ActorNavigationId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FilmActors_Movies_FilmId1",
                        column: x => x.FilmId1,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmDirectors_Movies_FilmId1",
                        column: x => x.FilmId1,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieOrders_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowTimes_Movies_FilmId1",
                        column: x => x.FilmId1,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShowTimes_ProjectionRooms_ProjectionRoomId",
                        column: x => x.ProjectionRoomId,
                        principalTable: "ProjectionRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Employees_EmployeeNavigationId",
                        column: x => x.EmployeeNavigationId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_ShowTimes_ShowTimesNavigationId",
                        column: x => x.ShowTimesNavigationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmActors_ActorNavigationId",
                table: "FilmActors",
                column: "ActorNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_FilmActors_FilmId1",
                table: "FilmActors",
                column: "FilmId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmDirectors_FilmId1",
                table: "FilmDirectors",
                column: "FilmId1");

            migrationBuilder.CreateIndex(
                name: "IX_LikeActors_ActorId",
                table: "LikeActors",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_LikeDirectors_DirectorId",
                table: "LikeDirectors",
                column: "DirectorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieOrders_EmployeeId",
                table: "MovieOrders",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectionRooms_CinemaId",
                table: "ProjectionRooms",
                column: "CinemaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShowTimes_FilmId1",
                table: "ShowTimes",
                column: "FilmId1");

            migrationBuilder.CreateIndex(
                name: "IX_ShowTimes_ProjectionRoomId",
                table: "ShowTimes",
                column: "ProjectionRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_EmployeeNavigationId",
                table: "Tickets",
                column: "EmployeeNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ShowTimesNavigationId",
                table: "Tickets",
                column: "ShowTimesNavigationId");
        }
